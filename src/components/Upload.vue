    ...
    <div class="bg-white rounded border border-gray-200 relative flex flex-col">
        ...
        <div class="p-6">
            ...
            <div class="w-full px-10 py-20 rounded text-center cursor-pointer border border-dashed border-gray-400 text-gray-400 transition duration-500 hover:text-white hover:bg-green-400 hover:border-green-400 hover:border-solid"
                :class="{ 'bg-green-400 text-white border-green-400 border-solid': is_dragover }" @drag.prevent.stop=""
...
<script >
import { auth, storage, songsCollection } from "@/includes/firebase.js";
export default {
        ...
        upload($event) {
            ...
            files.forEach((file) => {
                ...
                const uploadIndex = this.uploads.push({
                    task,
                    name: file.name,
                    current_progress: 0, variant: 'bg-blue-500',
                ...
                task.on('state_changed', (snapshot) => {
                    ...
                    (e) => {
                        ...
                        this.uploads[uploadIndex].name = `Error Make sure the song size is smaller that 10 mb`;
                    ...
                    async () => {
                        ...
                        const song = {
                            ...
                            modefied_name: task.snapshot.ref.name,
                            comments_count: 0,
                            genre: ''
                        ...
                        this.uploads[uploadIndex].name = ` ${this.uploads[uploadIndex].name} uploaded succesfully`;
                    })
            })
